...
\section{Wnioski}
Na drodze implementacji biblioteki do obliczeń rozmytych i podsumowań llingwistycznych, przeprowadzonych eksperymentów oraz ich dyskusji, wyciągneliśmy następujące wnioski:
\begin{itemize}[label=$\bullet$\scshape\bfseries]
